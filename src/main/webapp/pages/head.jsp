<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="head">
		...
		<div class="nav">
            ...
            <div style="float:right;margin-right:55px;color:gray;">
                ...
                <a href="?p=sys/help" title="系统帮助"><img style="border:0px;" height="20" width="20" src="/resources/images/Help.png">&nbsp;<b>系统帮助</b></a>
            </div>
        </div>

...
import com.eweblib.validators.ValidatorUtil;
...
//
//		userQuery.limitColumns(new String[] { User.DEFAULT_ADDRESS, User.EMAIL, User.MOBILE_NUMBER, User.USER_NAME, User.NAME, User.SEX, User.AGE, User.ID, User.STATUS });
...
//		if (fromApp) {
//			// query field return to client
//			nameQuery.limitColumns(new String[] { User.DEFAULT_ADDRESS, User.EMAIL, User.MOBILE_NUMBER, User.USER_NAME, User.NAME, User.SEX, User.AGE, User.ID, User.USER_CITY_NAME, User.STATUS });
//			
//		
//			u.setUserId(u.getId());
//			
...
//		builder.limitColumns(new String[]{User.USER_NAME, User.MOBILE_NUMBER, User.NAME, User.DEFAULT_ADDRESS, User.AGE, User.SEX, User.EMAIL, User.USER_CITY_NAME, User.ID});
